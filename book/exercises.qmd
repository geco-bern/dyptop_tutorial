...
You can find all code shown and data used in this tutorial [here](https://github.com/stineb/dyptop_tutorial) (code in `.qmd` files stored under `book/`, data in `data/`). 
